...
class PublishHandState(object):
    def __init__(self):
        ...
        rospy.Subscriber("/hsrb_07/joy", Joy, self.cb_joy, queue_size=10)
...
#        map2hand = self.buf.lookup_transform_full()
        hand = data.position[7]
        try:
            map2hand = self.buf.lookup_transform("map", "hand_palm_link",rospy.Time(0),rospy.Duration(3.0))
...
#            print "open"
        ...
        # else:
        #     hand_state = 0
        hand_state = self.hand_joy_command
